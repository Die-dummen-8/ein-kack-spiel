if (localStorage.firsttimeplay == "") {
  alert('In diesem Spiel ist es 2125. Kacka ist wertvoller als Gold.\nKlicke auf den Kackhaufen um Kacka zu kriegen. Kacka wird alle 10 Sekunden automatisch verkauft.\nWerde der reichste Mensch der welt und mache einen Milliarden-Umsatz mit Kacka!\n\nBenutze den Code "pear" für mehr Optionen.')
...
function openResetMenue() {
  ...
  '<div class="overlay">\n' +
  '  <div class="popupp">\n' +
  '    <div class="heading">Reset</div>\n' +
  '    <div class="x" onclick="closePopup()">iClose</div>\n' +
  '    <button class="btn" onclick="reset()">\n' +
  '      Hier klicken, um das Game zurückzusetzen.\n' +
  '    </button>\n' +
  '  </div>\n' +
  '</div>'
};
